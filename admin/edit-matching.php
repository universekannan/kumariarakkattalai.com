...
if (isset($_POST['submit'])) {
    ...
    $status = trim($_POST['status']);
        ...
        $stmt = $conn->prepare("UPDATE  ka_blood_group set from_id=?,matching_nmae=?, status=? where id=?");

        $stmt->bind_param("Ssss",$from_id,$matching_nmae,$status,$id);
        $stmt->execute();
		        header("location: view-bloods.php");

    }

$sql3 = "select * from ka_matchings where id=$id";
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <label>Select Course</label>
                ...
                <?php
                $sql = "select * from ka_blood_group where id=$id";
        ...
        <div class="form-group">
            <label>Select Course</label>
                ...
                ?>
			<option value="<?php echo $row3['id']; ?>" <?php if($row['id'] == $row2['id']) { echo 'selected'; } ?> ><?php echo $row2['blood_nmae'] ?></option> 
                <?php } ?>
                </select>
            </div> 
