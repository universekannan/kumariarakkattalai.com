            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
                        ...
                        $sql = "select a.*,b.blood_nmae from ka_matchings a,ka_blood_group b where a.from_id=b.id";
                ...
                <tr>
				  ...
				  <td><?php echo $row['matching_nmae']; ?></td>

                  <td><?php echo $row['status']; ?></td>
				  <td>								
								<a class="btn btn-info fa fa-edit" href="edit-matching.php?id=<?php echo $row['id']; ?>" title="Edit "></a>
