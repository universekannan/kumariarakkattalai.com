...
<?php
$sql = "select a.*,b.photo from ka_events a,ka_images b where a.id=b.event_id and b.serial_no='1' order by a.date desc limit 9";
...
.styled {
	...
	<center><a class="favorite styled"
        type="button" href="all-events.php"> More Events</a></center>
    </div>
    </div>
</main>
